...
$sql="update  tblusers set FullName=:fname,Emailid=:emailid,PhoneNumber=:pnumber,UserGender=:sex where Userid=:uid ";
$query = $dbh->prepare($sql);
//save data to  the values
...
<option value="ChooseNotToSay">Choose Not To Say</option>
</select>
</div>
                                            </div>
