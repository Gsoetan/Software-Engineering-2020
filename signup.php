...
$sql="INSERT INTO tblusers(FullName,UserName,Emailid,PhoneNumber,UserPassword,IsActive) VALUES(:fname,:uname,:emailid,:pnumber,:password,:status)";

$query = $dbh->prepare($sql);
//storing queried values
...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Event Management System | signup </title>
		<!-- bootstrap  css -->
