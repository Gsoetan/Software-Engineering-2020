...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Phony Staples Ceneter Management System | Reservations </title>
                       ...
                       <div class="col-md-8 col-sm-7">
                           <div class="single-blog-body">
                                ...
                                <div class="Leave-your-thought mt50">
                                    <h3 class="aside-title uppercase">My Reservations</h3>
...
if($bstatus==""){
echo htmlentities("Haven't confirmed Yet");
} else {
