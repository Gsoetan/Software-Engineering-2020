...
$eid=intval($_GET['evntid']);
$isactive=1;
$sql = "SELECT tblcategory.CategoryName,tblevents.EventName,tblevents.EventLocation,tblevents.EventStartDate,tblevents.EventEndDate,tblevents.EventImage,tblevents.id,tblevents.EventDescription,tblevents.PostingDate,tblevents.EventImage from tblevents left join tblcategory on tblcategory.id=tblevents.CategoryId where tblevents.id=:eid and tblevents.IsActive=:isactive";
$query = $dbh -> prepare($sql);
...
<?php } ?>     
            ...
            <!--about area end-->
        <?php }} else {?>
     <h3 align="center" style="color:blue; margin-top: 4%">No record found</h3>
 <?php }?>
